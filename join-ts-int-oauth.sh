...
sleep 2
runAsUser /Applications/Tailscale.app/Contents/MacOS/Tailscale login --authkey "'"$TAILSCALEAUTHKEY?ephemeral=true&preauthorized=true"'" --hostname "purplesupportsession-ticket-$ZDTICKETRAW-engineer-$TSENGINEER" --advertise-tags="tag:$TSTAG"
